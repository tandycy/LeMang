...
#define FP_POPOVER_ARROW_BASE 15.0
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _titleLabel.font = [UIFont fontWithName:defaultBoldFont size:15];
...
-(CGGradientRef)createGradient
{
    ...
    else if(self.tint == FPPopoverYellowTinit)
    {
        if(_arrowDirection == FPPopoverArrowDirectionUp)
        {
            colors[0] = 0.94; colors[1] = 0.42; colors[2] = 0.12;
            colors[4] = 0.94; colors[5] = 0.42; colors[6] = 0.12;
            colors[3] = colors[7] = 1.0;
...
- (void)drawRect:(CGRect)rect
{
    ...
    {
        CGContextSetRGBFillColor(ctx, 0.94, 0.42, 0.12, 1.0);
    }
